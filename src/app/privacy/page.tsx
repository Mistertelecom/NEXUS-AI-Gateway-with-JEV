      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-text-muted leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              <code className="text-zinc-300 font-mono text-sm">~/.nexus/storage.sqlite</code>:
            </p>
          ...
          <section>
            ...
            <p>
              ...
              <code className="text-zinc-300 font-mono text-sm">~/.nexus/</code>{" "}
        ...
        <div className="mt-12 pt-8 border-t border-white/[0.06] text-sm text-text-muted">
          <p>
            {t("questionsVisit")}{" "}
            <a
              href="https://github.com/nexus-ai-gateway/nexus"
