...
export async function generateMetadata() {
  ...
  return {
    title: "NEXUS — alpha control plane",
    description: "NEXUS alpha: a control plane for Lead and Worker execution through JEV.",
  ...
  return (
    <html lang={locale} dir={isRtl ? "rtl" : "ltr"} suppressHydrationWarning>
      ...
      <body className="font-sans antialiased" suppressHydrationWarning>
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-50 focus:px-4 focus:py-2 focus:bg-white focus:text-black focus:border focus:border-zinc-300 focus:rounded-lg focus:text-xs focus:font-mono focus:font-bold focus:shadow-xl"
        >
          {t("skipToContent")}
        </a>
