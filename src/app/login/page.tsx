    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6">
        ...
        >
          ...
          <p className="text-center text-xs text-text-muted/60 mt-8">NEXUS — {t("unifiedProxy")}</p>
        </div>
      </div>
    );
  }
          ...
          >
            <div className="mb-10">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-10 h-10 rounded-xl bg-zinc-900 border border-white/20 flex items-center justify-center shadow-lg">
                  <NexusLogo size={22} className="text-white" />
                </div>
                <span className="text-xl font-bold font-mono tracking-wider text-white">NEXUS</span>
              </div>
              <h1 className="text-2xl font-bold text-white tracking-tight">{t("signIn")}</h1>
              <p className="text-zinc-400 mt-1.5 font-mono text-xs">
