...
// (#618) Match any custom:NEXUS-<i> or custom:OmniRoute-<i> entry (multi-model).
const isOmniRouteEntry = (m) =>
  typeof m?.id === "string" &&
  (m.id.startsWith("custom:NEXUS") || m.id.startsWith("custom:OmniRoute"));
