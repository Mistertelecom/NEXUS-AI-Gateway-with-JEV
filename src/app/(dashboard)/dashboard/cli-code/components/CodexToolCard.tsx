...
export default function CodexToolCard({
  ...
  const getManualConfigs = () => {
    const keyToUse = !cloudEnabled ? "sk_omniroute" : "<YOUR_NEXUS_API_KEY>";

    let configContent = `# NEXUS Configuration for Codex CLI
model = "${selectedModel || CODEX_DEFAULT_MODELS[0]}"`;
...
# Utilize the built-in OpenAI provider pointed to NEXUS
