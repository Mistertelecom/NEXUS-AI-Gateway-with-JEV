    ...
    <Card padding="md">
      <div className="space-y-4">
        ...
        <div className="space-y-2 border-t border-border pt-3">
          <p className="text-xs font-medium">Import from NEXUS</p>
          <p className="text-xs text-text-muted">
            Reuse an existing NEXUS Claude connection&apos;s OAuth tokens instead of logging in
          ...
          {omniLoading && omniConnections.length === 0 ? (
            ...
            <div className="flex items-center justify-between gap-3 rounded-lg border border-border px-3 py-2">
              <p className="text-xs text-text-muted">No eligible NEXUS Claude connections found.</p>
              <Tooltip content="Will be active once a Claude connection exists in NEXUS.">
