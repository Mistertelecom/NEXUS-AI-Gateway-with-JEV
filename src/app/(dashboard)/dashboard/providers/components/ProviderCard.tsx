...
const ProviderCard = forwardRef<ProviderCardHandle, ProviderCardProps>(function ProviderCard(
  ...
  const kimiOfficialSupporterChip = isKimiPartner ? (
    <span
      ...
      className="inline-flex items-center gap-0.5 rounded-full border border-zinc-700 bg-zinc-900 px-1.5 py-0.5 text-[9px] font-mono font-semibold uppercase tracking-wide leading-none text-zinc-300"
      title={providerText(
        t,
        "kimiOfficialSupporterTooltip",
        "Kimi (Moonshot AI) is NEXUS's founding Open Source Friend"
      )}
    >
  ...
  // Cheaper Inference Open Source Friend badge
  const cheaperInferenceSupporterChip = isCheaperInferencePartner ? (
    <span
      ...
      title={providerText(
        ...
        "Cheaper Inference backs NEXUS as an Open Source Friend"
      )}
    >
      <span className="material-symbols-outlined text-[10px] leading-none">verified</span>
