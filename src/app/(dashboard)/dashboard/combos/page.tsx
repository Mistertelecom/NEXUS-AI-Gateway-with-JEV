      ...
      <div className="mt-3 rounded-lg border border-primary/20 bg-primary/5 px-3 py-2">
        ...
        <p className="mt-1 text-[11px] leading-4 text-text-muted">
          {getI18nOrFallback(
            ...
            "openrouter/auto is a real paid OpenRouter product (Auto Best Available), not a NEXUS alias — exclude it via Settings → Routing → Hide paid models."
          )}
        </p>
      </div>
                      ...
                      <div>
                        <FieldLabelWithHelp
                          ...
                          help={getI18nOrFallback(
                            ...
                            "When quota usage reaches this threshold, NEXUS generates a structured handoff summary before the account is exhausted."
                          )}
                          showHelp={!isExpertMode}
                        />
                        <input
