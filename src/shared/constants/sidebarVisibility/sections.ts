...
const NEXUS_ITEMS: readonly SidebarItemDefinition[] = [
  {
    id: "nexus-workflows",
    href: "/dashboard/nexus",
    i18nKey: "nexusWorkflows",
    labelFallback: "Estúdio de Pairs",
    subtitleKey: "nexusWorkflowsSubtitle",
    subtitleFallback: "Lead, JEV e Worker",
    icon: "account_tree",
  },
  {
    id: "nexus-executions",
    href: "/dashboard/nexus/executions",
    i18nKey: "nexusExecutions",
    labelFallback: "Execuções",
    icon: "history",
  },
  {
    id: "nexus-telemetry",
    href: "/dashboard/nexus/telemetry",
    i18nKey: "nexusTelemetry",
    labelFallback: "Telemetria",
    subtitleKey: "nexusTelemetrySubtitle",
    subtitleFallback: "Latência e decisões",
    icon: "radar",
  },
  {
    id: "nexus-providers",
    href: "/dashboard/nexus/providers",
    i18nKey: "nexusProviders",
    labelFallback: "Provedores",
    subtitleKey: "nexusProvidersSubtitle",
    subtitleFallback: "Catálogo e prontidão",
    icon: "memory",
  },
  {
    id: "nexus-compression",
    href: "/dashboard/nexus/compression",
    i18nKey: "nexusCompression",
    labelFallback: "Compressão",
    subtitleKey: "nexusCompressionSubtitle",
    subtitleFallback: "Otimização de contexto",
    icon: "compress",
  },
  {
    id: "nexus-diagnostics",
    href: "/dashboard/nexus/diagnostics",
    i18nKey: "nexusDiagnostics",
    labelFallback: "Diagnóstico",
    subtitleKey: "nexusDiagnosticsSubtitle",
    subtitleFallback: "Saúde do sistema",
    icon: "shield",
  },
  {
    id: "nexus-clients",
    href: "/dashboard/nexus/clients",
    i18nKey: "nexusClients",
    labelFallback: "Integrações",
    subtitleKey: "nexusClientsSubtitle",
    subtitleFallback: "Conectores e clientes",
    icon: "terminal",
  },
];
...
const HELP_ITEMS: readonly SidebarItemDefinition[] = [
  ...
  {
    id: "issues",
    href: "https://github.com/nexus-ai-gateway/nexus/issues",
    i18nKey: "issues",
...
export const SIDEBAR_SECTIONS: readonly SidebarSectionDefinition[] = [
  ...
  {
    id: "nexus",
    titleKey: "nexusSection",
    titleFallback: "NEXUS Core",
    children: NEXUS_ITEMS,
    defaultPinned: true,
  },
  {
    id: "monitoring",
  ...
  },
  {
    ...
    titleFallback: "Painel de Controle",
