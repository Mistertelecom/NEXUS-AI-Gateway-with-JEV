...
export default function ConsoleLogViewer() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        {/* Header bar */}
        <div className="sticky top-0 z-10 px-4 py-2 bg-zinc-950 border-b border-zinc-800 flex items-center gap-2">
          <div className="w-2.5 h-2.5 rounded-full bg-zinc-700" />
          <div className="w-2.5 h-2.5 rounded-full bg-zinc-700" />
          <div className="w-2.5 h-2.5 rounded-full bg-zinc-700" />
          <span className="ml-3 text-zinc-400 text-[11px] font-mono tracking-tight">
            NEXUS — {tv("applicationConsole")}
          </span>
        </div>
