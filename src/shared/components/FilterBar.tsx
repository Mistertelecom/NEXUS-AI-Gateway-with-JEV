        ...
        <div key={filter.key} style={{ position: "relative" }}>
          <button
            ...
            style={{
              padding: "6px 12px",
              borderRadius: "6px",
              border: `1px solid ${activeFilters[filter.key] ? "rgba(255,255,255,0.5)" : "rgba(255,255,255,0.1)"}`,
              background: activeFilters[filter.key]
                ? "rgba(255,255,255,0.12)"
                : "rgba(255,255,255,0.03)",
              color: activeFilters[filter.key] ? "#ffffff" : "#a1a1aa",
              fontSize: "12px",
              cursor: "pointer",
              whiteSpace: "nowrap",
              ...
              {(filter.options || []).map((opt) => (
                <button
                  ...
                  style={{
                    ...
                    textAlign: "left",
                    background:
                      activeFilters[filter.key] === opt ? "rgba(255,255,255,0.15)" : "none",
                    border: "none",
                    color: activeFilters[filter.key] === opt ? "#ffffff" : "#d4d4d8",
                    fontSize: "12px",
                    cursor: "pointer",
                    borderRadius: "4px",
                    fontFamily: "monospace",
