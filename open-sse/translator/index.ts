...
import { isNexusWorkerStage, withWorkerReasoningDisabled } from "@/nexus/pairs/workerStage";
...
export function translateRequest(
  ...
  if (isNexusWorkerStage(result)) {
    result = withWorkerReasoningDisabled(result);
  }
