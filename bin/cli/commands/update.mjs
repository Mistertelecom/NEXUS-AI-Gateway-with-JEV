...
export async function runUpdateCommand(opts = {}) {
  if (productPackage.name !== "omniroute") {
    printError(
      "NEXUS_UPDATE_DISABLED: automatic updates are disabled for this NEXUS alpha. Install only an explicitly approved NEXUS release artifact."
    );
    return 1;
  }
